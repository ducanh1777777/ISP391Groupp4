 ...
 * @author NGUYEN MINH
 */
public class DetailInvoice2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Invoice> list = dao.getAllInvoices(partnerid,partnername);
        request.setAttribute("list", list);
        request.setAttribute("userid", userid);
        request.setAttribute("partnerid", partnerid);
        request.setAttribute("partnername", partnername);
        request.getRequestDispatcher("chitiet2.jsp").forward(request, response);
    } 
