...
.search-form input[type="submit"] {
    ...
    <body>
        <jsp:include page="header3.jsp"></jsp:include> 
            ...
            <h1 style="text-align: center;">Danh sách người nợ</h1>
            <a class="add-link" href="partner">Thêm người nợ</a>
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.user.isAdmin == 1 }">
                            <tr>
                                ...
                                <td>${u.amountMoney}</td>
                                <td><a href="AddDebtServlet?userid=${u.userid}&partnerid=${u.id}">Thêm nợ</a></td>
        ...
        <!--                            <td>${u.id}</td>
                                    ...
                                    <td>${u.partnerEmail}</td>
                                    <td>${u.amountMoney}</td>
                                    <td><a href="AddDebtServlet?userid=${u.userid}&partnerid=${u.id}">Sửa nợ</a></td>
                                    <td><a href="EditPartner?userid=${u.userid}&partnerid=${u.id}">Sửa</a></td>
                                    <td><a href="deletePartner?id=${u.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa?');">Xóa</a></td>
